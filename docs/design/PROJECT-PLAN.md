...
| 序号 | 任务 | 状态 | 说明 |
|------|------|------|------|
| 1 | 执行流多视图 | ✅ | 图形/ftrace/树形 切换 |
| 2 | ftrace 格式优化 | ✅ | 行号 + 内核API标记 + 异步机制标记 |
| 3 | 导出功能 | ✅ | 纯文本/Markdown/JSON |
| 4 | 帮助文档弹窗 | ✅ | 格式说明 + 标记含义 |
| 5 | 编辑器高度修复 | ✅ | 解决无法滚动到底的问题 |
